  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-9">
        ...
        <ul class="nav">
          <li class="nav-item"><a href="<?php echo base_url() ?>inicio" class="nav-link"> <h5 >INICIO</h5></a> </li>
          <li class="nav-item"><a href="#" class="nav-link"> <h5>SOBRE NOSOTROS</h5> </a> </li>
          <li class="nav-item"><a href="#" class="nav-link"> <h5>CONTACTO</h5> </a> </li>
          <li class="nav-item"><a href="#" class="nav-link"> <h5>BUSCAR VIAJE</h5> </a> </li>
